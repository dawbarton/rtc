classdef duffing_analogue_interface < rtc_interface
    %DUFFING_ANALOGUE_INTERFACE  Interface to the real-time control device
    ...
    methods
        function obj = duffing_analogue_interface()
